...
Store.create = File.create;

Store.init = (Env, store) => {
    ...
    Env.computeIndex = function(channelName, cb) {
        const CB = Util.once(cb);
...
*/
let getIndex = Store.getIndex = (Env, channelName, cb) => {
...
Store.storeMessage = function(Env, channel, msg, isCp, optionalMessageHash, time, cb) {
